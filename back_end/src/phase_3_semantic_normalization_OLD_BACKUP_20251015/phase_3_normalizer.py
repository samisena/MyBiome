...
from .phase_3_hierarchy_manager import HierarchyManager, initialize_database_schema
...
class MainNormalizer:
    ...
    def __init__(
        ...
        Args:
            db_path: Path to database (intervention_research.db with semantic_hierarchy tables)
        ...
        self.hierarchy_manager = HierarchyManager(db_path)
