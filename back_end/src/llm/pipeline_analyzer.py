...
from src.llm.emerging_category_analyzer import emerging_category_analyzer
...
class PipelineAnalyzer:
    ...
    def generate_research_insights(self) -> Dict[str, Any]:
        ...
        """
        logger.info("Generating research insights from interventions data")
    ...
    def _analyze_emerging_categories(self) -> Dict[str, Any]:
        ...
        try:
            logger.info("Analyzing emerging categories...")
