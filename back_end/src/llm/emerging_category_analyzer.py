...
class EmergingCategoryAnalyzer:
    ...
    def analyze_emerging_interventions(self, min_intervention_count: int = 3,
        ...
        """
        logger.info("Starting emerging category analysis...")

        # Get all emerging interventions
        emerging_interventions = self._get_emerging_interventions()

        if not emerging_interventions:
            logger.info("No emerging interventions found")
            return []

        logger.info(f"Analyzing {len(emerging_interventions)} emerging interventions")
        ...
        logger.info(f"Found {len(candidates)} emerging category candidates")
        return candidates
