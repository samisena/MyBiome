...
from back_end.src.phase_3_semantic_normalization.phase_3b_intervention_categorizer import GroupBasedCategorizer
from back_end.src.phase_3_semantic_normalization.validation import validate_all
...
class RotationGroupCategorizer:
    ...
    def run(self, condition: Optional[str] = None) -> Dict:
        ...
        from back_end.src.phase_3_semantic_normalization.phase_3b_condition_categorizer import ConditionGroupBasedCategorizer
