...
from back_end.src.phase_1_data_collection.phase_1_paper_parser import PubmedParser
from back_end.src.phase_1_data_collection.phase_1_fulltext_retriever import FullTextRetriever
...
class PubMedCollector:
    ...
    def _collect_with_interleaved_s2(self, condition: str, query: str, min_year: int,
        ...
        from back_end.src.phase_1_data_collection.phase_1_semantic_scholar_enrichment import SemanticScholarEnricher
