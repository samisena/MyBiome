...
class PubmedParser:
    ...
    def _parse_single_article(self, article: ET.Element) -> Optional[Dict]:
        ...
        try:
            ...
            if article_meta is None:
                # Article missing Article element - skipping
                pass
                return None
    ...
    def parse_all_metadata_files(self, pattern: str = "pubmed_batch_*.xml") -> List[Dict]:
        ...
        if not xml_files:
            # No XML files found matching pattern
            return []
        
        # XML files found for parsing
        ...
        # Parsing complete (removed verbose statistics)
