...
from back_end.src.data.api_clients import get_pmc_client, get_unpaywall_client
...
class FullTextRetriever:
    ...
    def __init__(self, db_manager=None):
        ...
        # Enhanced fulltext retriever initialized
    ...
    def check_and_retrieve_fulltext(self, paper: Dict) -> Dict[str, Any]:
        ...
        # Processing fulltext for paper
        
        # Try PMC first if PMC ID is available
        if pmc_id:
            # Attempting PMC retrieval
        ...
        if doi and not result['success']:
            # Attempting Unpaywall retrieval
    ...
    def _retrieve_from_pmc(self, pmc_id: str, pmid: str) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                # PMC fulltext retrieved successfully
            except Exception as e:
    ...
    def _retrieve_from_unpaywall(self, doi: str, pmid: str) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                result['success'] = True
                result['path'] = str(file_path)
                # Unpaywall PDF retrieved successfully
            except Exception as e:
    ...
    def process_papers_batch(self, papers: List[Dict], 
        ...
        Returns:
            Summary statistics
        """
        # Processing papers for fulltext retrieval
        ...
        # Fulltext candidates identified
        ...
        # Fulltext retrieval complete (removed verbose summary logging)
